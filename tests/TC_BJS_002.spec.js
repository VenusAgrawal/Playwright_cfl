...
test ("Basic journey Check in Luxembourg: for Arrival", async({page})=>{
...
// click to "Arrival" checkbox
const text = await page.locator("//label[@for='quick-search-type-arrival']").click()
...
// check "Arrival" checkbox is selected on search results page
await expect(page.locator("//label[@for='arrival-bullet1282983651']")).toBeChecked()
})